...
const dynamicContent = `
  ...
  <a href="https://infolink.vercel.app/" class="fixed flex items-center top-4 left-16">
    <span>
      <img src="https://aungthuoo.github.io/share/assets/logo/logo-ver-tran.png" style="width:50px;" alt="infolink" class="w-30 h-30 p-0"/>
...
document.getElementById('backButton').addEventListener('click', function() {
  const redirectUrl = 'https://infolink.vercel.app';
